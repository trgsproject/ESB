...
public class RegisterPatientNurse extends AppCompatActivity {

    private TextView textViewUserName, textViewUsersubsp, textViewUserfullname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_patient_nurse);
        ...
        if (ContextCompat.checkSelfPermission(RegisterPatientNurse.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(RegisterPatientNurse.this, new String[]{
        ...
        button_capture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CropImage.activity().setGuidelines(CropImageView.Guidelines.ON).start(RegisterPatientNurse.this);
        ...
        button_Capture_Manually.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(RegisterPatientNurse.this,RegisterPatientManually.class);
                startActivity(i);
    ...
    private void getTextFromImage(Bitmap bitmap) {
        ...
        if (!recognizer.isOperational()) {
            ...
            Intent intent = new Intent(RegisterPatientNurse.this, RegisterPatientDetails.class);
