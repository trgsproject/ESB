...
public class PatientViewDetailsNurse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_view_details_nurse);
        ...
        tvID.setText(PatientList.patientArrayList.get(position).getId());
        tvMRN.setText(PatientList.patientArrayList.get(position).getMRN());
        tvName.setText(PatientList.patientArrayList.get(position).getName());
        tvAge.setText(PatientList.patientArrayList.get(position).getAge());
        tvGender.setText(PatientList.patientArrayList.get(position).getGender());
        tvNationality.setText(PatientList.patientArrayList.get(position).getNationality());
        tvRace.setText(PatientList.patientArrayList.get(position).getRace());
        tvCountry.setText(PatientList.patientArrayList.get(position).getCountry());
        tvWard.setText(PatientList.patientArrayList.get(position).getWard());
        tvSurgeonName.setText(PatientList.patientArrayList.get(position).getSurgeonName());
        tvDiagnosisDescription.setText(PatientList.patientArrayList.get(position).getDiagnosisDescription());
        tvProcedure1.setText(PatientList.patientArrayList.get(position).getProcedureName1());
        tvProcedure2.setText(PatientList.patientArrayList.get(position).getProcedureName2());
        tvProcedure3.setText(PatientList.patientArrayList.get(position).getProcedureName3());
        tvSubSpecialty.setText(PatientList.patientArrayList.get(position).getSubSpecialty());
        tvLastMeal.setText(PatientList.patientArrayList.get(position).getLastMeal());
        tvInformAnesthetist.setText(PatientList.patientArrayList.get(position).getInformAnesthetist());
        tvAnesthetistName.setText(PatientList.patientArrayList.get(position).getAnesthetistName());
        tvHighDependencyArea.setText(PatientList.patientArrayList.get(position).getHighDependencyArea());
        tvArrivalTime.setText(PatientList.patientArrayList.get(position).getArrivalTime());
        tvApprovedTime.setText(PatientList.patientArrayList.get(position).getApprovedTime());
        tvStatus.setText(PatientList.patientArrayList.get(position).getStatus());
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PatientViewDetailsNurse.this, PatientList.class);
                startActivity(i);
            }
        });
