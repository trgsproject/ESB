...
public class ChangePasswordSurgeon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_password_surgeon);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ChangePasswordSurgeon.this,SettingSurgeon.class);
                startActivity(i);
            }
        });
    ...
    public void btn_updatePass(View view) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST,  URL.urls + "updatePass.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(ChangePasswordSurgeon.this, response, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ChangePasswordSurgeon.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ChangePasswordSurgeon.this);
