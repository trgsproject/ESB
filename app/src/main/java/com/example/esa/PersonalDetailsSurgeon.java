...
public class PersonalDetailsSurgeon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_details_surgeon);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PersonalDetailsSurgeon.this,SettingSurgeon.class);
                startActivity(i);
            }
        });
    ...
    public void btn_updateData (View view){
        ...
        final String name = textName.getText().toString().toUpperCase().toUpperCase();
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URL.urls + "updateUser.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(PersonalDetailsSurgeon.this, response, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PersonalDetailsSurgeon.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PersonalDetailsSurgeon.this);
