...
public class SettingSurgeon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_surgeon);
        ...
        personalDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(SettingSurgeon.this,PersonalDetailsSurgeon.class);
                startActivity(i);
            }
        });
        ...
        changePassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(SettingSurgeon.this,ChangePasswordSurgeon.class);
                startActivity(i);
            }
        });
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(SettingSurgeon.this,AboutSurgeon.class);
                startActivity(i);
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPrefManager.getInstance(SettingSurgeon.this).logout();
                Intent i = new Intent(SettingSurgeon.this,Login.class);
