    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PersonalDetails.this,Setting.class);
                startActivity(i);
            }
        });
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URL.urls + "updateUser.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(PersonalDetails.this, response, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PersonalDetails.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
